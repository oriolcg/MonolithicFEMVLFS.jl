...
function run_energy_test(case::Periodic_Beam_FS_params)
...
produce_or_load(path,case,run_energy_test;digits=8)
...
Δt = 1.0e-3
order = 4
path = datadir("PeriodicBeamFSEnergy")
for i in 1:5
  nelem = 2^(i+1)
  case = Periodic_Beam_FS_params(
...
# Save
savefig(plt1,plotsdir("PeriodicBeamFSEnergy","error_mesh_vs_time.png"))
savefig(plt2,plotsdir("PeriodicBeamFSEnergy","error_convergence_time.png"))
end
